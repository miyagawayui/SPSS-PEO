 ...
 */
 ...
 import parse from "@ui5/webcomponents-base/dist/PropertiesFileFormat";
 import { registerI18nLoader, getI18nBundle } from "@ui5/webcomponents-base/dist/i18nBundle";
 import { getLanguage, setFetchDefaultLanguage } from "@ui5/webcomponents-base/dist/config/Language";
 
 setFetchDefaultLanguage(true);				// propertiesを使えるようにする設定
 var propertiesStatus = "200";				// プロパティファイルの読み込みステータス
 // サポート言語
 const supportedLocales = [
						   "ar", "bg", "ca", "cs", "cy", "da", "de", "el", "en", "en_GB", "es", "es_MX", "et", "fi", "fr", "fr_CA", "hi", "hr", "hu", "in", "it", "iw", 
						   "ja", "kk", "ko", "lt", "lv", "ms", "nl", "no", "pl", "pt_PT", "pt", "ro", "ru", "sh", "sk", "sl", "sv", "th", "tr", "uk", "vi"
						  ];	
